...
def handleSerialData(raw_data):
    ...
    if key < 11:  
        ...
        if angle_flag:
            ...
            #imu_encoder_msg.angle = (angle_s + np.pi) % (2*np.pi) - np.pi
            #print(angle_s)
...
def callback(data):
    global readreg, flag, calibuff, wt_imu, iapflag, mag_offset, mag_range, version, recordflag, baudlist, offset_mag, offset_mag2, theta
