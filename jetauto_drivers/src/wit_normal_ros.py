...
def handleSerialData(raw_data):
    global buff, key, angle_degree, magnetometer, acceleration, angularVelocity, pub_flag, readreg, calibuff, flag, mag_offset, mag_range, version, longitude_imu, latitude_imu, altitude_imu, offset_mag
    angle_flag=False
    if python_version == '2':
...
if __name__== '__main__':
    ...
    find_ttyUSB()
    #rospy.init_node("imu")
    port = rospy.get_param("port", "/dev/ttyUSB1")   #THS1
